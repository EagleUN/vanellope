...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { age: @hero.age, info: @hero.info, name: @hero.name, salary: @hero.salary } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { age: @hero.age, info: @hero.info, name: @hero.name, salary: @hero.salary } }
